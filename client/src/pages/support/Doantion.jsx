  ...
  const handleReceiptRequest = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/api/public/donations",
        formData,
        { headers: { "Content-Type": "multipart/form-data" } }
      );

      alert(`Receipt request submitted for INR ${amount}. Receipt will be sent to ${email}.`);
      setName("");
      setEmail("");
      setAmount("");
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <form onSubmit={handleReceiptRequest} encType="multipart/form-data">
          ...
          <div className="mb-4">
            ...
            <input 
              type="email" placeholder="e.g., your@email.com"
              className="w-full p-2 border rounded-md"
          ...
          <div className="mb-4">
            ...
            <input 
              type="number" min="1" placeholder="Enter the donated amount"
              className="w-full p-2 border rounded-md"
              ...
              {["Bank Transfer", "Cheque", "UPI", "Other"].map((mode) => (
                <label key={mode} className="flex items-center gap-2">
                  <input 
                    ...
                    checked={paymentMode === mode} onChange={(e) => setPaymentMode(e.target.value)}
                  />
                  {mode}
                </label>
              ))}
          ...
          <div className="mb-4">
            ...
            <input 
              type="text" placeholder="Enter UTR Number or Name"
              className="w-full p-2 border rounded-md"
          ...
          <div className="mb-4">
            <label className="block mb-2 font-medium">Upload Screenshot (optional)</label>
            <input 
