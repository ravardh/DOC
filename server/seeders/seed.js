...
const seedGallery = async () => {
  try {
    const gallery = [
      {
        imagePath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/gallery/event1.jpg',
        category: 'Events',
        name: 'Annual Fundraiser 2024',
      },
      {
        imagePath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/gallery/education1.jpg',
        category: 'Education',
        name: 'School Donation Drive',
      },
      {
        imagePath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/gallery/health1.jpg',
        category: 'Healthcare',
        name: 'Medical Camp 2024',
      },
      {
        imagePath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/gallery/environment1.jpg',
        category: 'Environment',
        name: 'Tree Plantation Drive',
      },
      {
        imagePath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/gallery/community1.jpg',
        category: 'Community',
...
const seedCoreTeam = async () => {
  try {
    const coreTeam = [
      {
        profilePhotoPath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/core-team/director.jpg',
        name: 'Dr. Amit Patel',
        position: 'Director',
      ...
      {
        profilePhotoPath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/core-team/co-director.jpg',
      ...
      {
        profilePhotoPath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/core-team/head-education.jpg',
        name: 'Rahul Verma',
      ...
      {
        profilePhotoPath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/core-team/head-healthcare.jpg',
        name: 'Dr. Neha Gupta',
      ...
      {
        profilePhotoPath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/core-team/head-environment.jpg',
        name: 'Arun Kumar',
...
const seedDonations = async () => {
  try {
    const donations = [
      {
        name: 'David Wilson',
        screenshotPath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/donations/donation1.jpg',
        email: 'david@example.com',
        amount: 5000,
        mode: 'UPI',
        utr: 'UPI123456789',
      ...
      {
        name: 'Sarah Johnson',
        screenshotPath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/donations/donation2.jpg',
      ...
      {
        name: 'Michael Chen',
        screenshotPath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/donations/donation3.jpg',
        email: 'michael@example.com',
        amount: 2500,
        mode: 'UPI',
        utr: 'UPI987654321',
      ...
      {
        name: 'Emily Davis',
        screenshotPath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/donations/donation4.jpg',
        email: 'emily@example.com',
        amount: 7500,
        mode: 'Bank Transfer',
        utr: 'BANK123456789',
      ...
      {
        name: 'Robert Wilson',
        screenshotPath: 'https://res.cloudinary.com/your-cloud-name/image/upload/v1/donations/donation5.jpg',
